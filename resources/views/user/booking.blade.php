...
@section('content')
<!-- Hanya tambahkan div pembungkus dengan scroll vertikal -->
<!-- Ubah height dari 70vh menjadi 80vh atau 85vh agar muat 1 lagi -->
<div style="height: 85vh; overflow-y: auto; overflow-x: hidden; padding-right: 5px;">

    <h2 class="fw-bold text-primary mb-4">My Booking</h2>
